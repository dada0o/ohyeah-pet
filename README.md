...
macOS 最新版：**v1.2.1**；Windows 当前稳定版：**v1.2.3**。请选择与你的系统和芯片匹配的文件：

| 系统 | 推荐下载 | 备用下载 | 说明 |
| --- | --- | --- | --- |
| Windows 10 / 11（64 位） | [下载一键安装版 EXE](https://github.com/dada0o/ohyeah-pet/releases/download/windows-v1.2.3/PetFriends-v1.2.3-Windows10-11-x64.exe) | [下载便携版 ZIP](https://github.com/dada0o/ohyeah-pet/releases/download/windows-v1.2.3/PetFriends-v1.2.3-Windows10-11-x64-Portable.zip) | 推荐安装版；24H2 Build 26100 自动使用兼容模式；便携版必须完整解压 |
| Windows 7 SP1（32/64 位） | [下载 .NET 3.5.1 免安装版 ZIP](https://github.com/dada0o/ohyeah-pet/releases/download/windows-v1.2.3/PetFriends-v1.2.3-Windows7-NoInstall-x86-x64.zip) | — | 完整解压后直接运行，不需要安装 .NET Framework 4.8 |
...
[查看 Windows v1.2.3 版本说明和全部文件](https://github.com/dada0o/ohyeah-pet/releases/tag/windows-v1.2.3)

Windows 10 和 Windows 11 使用同一个自包含版本，不需要另外安装 .NET 或 VC++ 运行库。v1.2.3 在 Windows 11 24H2 Build 26100 默认进入兼容启动模式，关闭可选的 WinForms 托盘图标和窗口 DWM 探测，并在上一次启动未完成时自动降级。开始菜单还提供手动“兼容模式”入口。诊断信息保存在 `%LOCALAPPDATA%\PetFriends\runtime.log` 和 `startup-in-progress.txt`。
...
| 版本 | 系统 | 下载 |
| --- | --- | --- |
| v1.2.3 | Windows 10 / 11 | [安装版 EXE](https://github.com/dada0o/ohyeah-pet/releases/download/windows-v1.2.3/PetFriends-v1.2.3-Windows10-11-x64.exe) · [便携版 ZIP](https://github.com/dada0o/ohyeah-pet/releases/download/windows-v1.2.3/PetFriends-v1.2.3-Windows10-11-x64-Portable.zip) |
| v1.2.3 | Windows 7 | [免安装版 ZIP](https://github.com/dada0o/ohyeah-pet/releases/download/windows-v1.2.3/PetFriends-v1.2.3-Windows7-NoInstall-x86-x64.zip) |
...
```powershell
./build-windows.ps1 -Version 1.2.3 -Architecture x64
```
